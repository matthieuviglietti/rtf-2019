...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-139450043-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-139450043-1');
</script>

	<script type="text/javascript" src="/wp-content/themes/Divi_child/tarteaucitron/tarteaucitron.js"></script>
